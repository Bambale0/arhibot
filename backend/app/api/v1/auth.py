...
@router.post(
    ...
    responses={409: {"model": ProblemDetails, "description": "Email is already registered."}},
)
...
@router.post(
    ...
    response_model=TokenPairResponse,
    responses={401: {"model": ProblemDetails, "description": "Invalid, expired, or reused token."}},
)
