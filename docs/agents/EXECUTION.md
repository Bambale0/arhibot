...
## Active work — dependency queue and Python 3.14 validation, 2026-09-26
...
- Completed baseline fixes: backup v2 (PR #127), slow/failed Ideas images with Playwright 1.63 (#58), aligned React/React DOM 19.3 (#104), Three/runtime types 0.186 (#103). TypeScript 7 (#54) is merged; its deployment and the Node 24/types/Python candidates remain in the delivery queue.
...
- Final gate: exact-head CI (including lock audit, integration/load/failure recovery, image builds and browser tests), sequential merge, dev deployment and server smoke. No new database migration, provider request, administrator permission or business configuration change.
