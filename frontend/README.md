...
- **Создать** — выбор всех объектов → фото участка или без фото → опросники всех выбранных объектов → одна общая генерация участка → принятие концепции → платные точечные правки или заявка;
